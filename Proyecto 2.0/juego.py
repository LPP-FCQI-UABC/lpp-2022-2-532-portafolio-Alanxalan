...
#El proyecto es el juego de Piedra, papel o tijera.
#Para este proyecto se utilizaron objetos, asignacion de vaores, op aritmeticos, op de asignacion, salida y entrada de datos, condicionales op de comparacion, etc.
#Al comenzar el juego se establece el numero de partidas que deberan ganarse para terminar el juego. 
#Al finalizar te aparece si fuiste el ganador, perdedor o quedo en empate.
